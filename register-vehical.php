...
if(isset($_POST['save'])){
	...
	if($_FILES['uploadfile']['name']){
		...
		$img="admin/uploads/".$_FILES['uploadfile']['name'];
	}
	
	$sql = "INSERT INTO newvehicles (`id`,`DriverName`,`file_name`,`VehiclesTitle`,`VehiclesBrand`,`PricePerDay`,`FuelType`,`ModelYear`,`SeatingCapacity`,`AirConditioner`,`PowerDoorLocks`,`AntiLockBrakingSystem`,`BrakeAssist`,`PowerSteering`,`DriverAirbag`,`PassengerAirbag`,`PowerWindows`)
   VALUES ('$id','$DriverName','$img','$VehiclesTitle',' $VehiclesBrand','$PricePerDay','$FuelType','$ModelYear','$SeatingCapacity','$AirConditioner','$PowerDoorLocks','$AntiLockBrakingSystem','$BrakeAssist','$PowerSteering','$DriverAirbag','$PassengerAirbag','$PowerWindows')";
...
<title>24x7 Ambulance Booking | MedDrive Services| Register Vehicle</title>
<!-- Font awesome -->
